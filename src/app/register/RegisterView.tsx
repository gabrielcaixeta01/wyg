          ...
          {submitted ? (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-green-500/20 border border-green-500/40 flex items-center justify-center mx-auto mb-6">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-green-400" aria-hidden="true">
            ...
            <>
              <h2 className="text-white font-black text-3xl lg:text-4xl mb-2">Quero ser parceiro</h2>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div>
                  <label
                    htmlFor="register-establishment"
                    className="text-lavender text-xs font-semibold uppercase tracking-wider block mb-2"
                  >
